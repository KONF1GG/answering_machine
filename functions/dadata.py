...
def find_login(mes):
    ...
    address_extraction_prompt = (
        ...
        "Не превращай Воронежскую в Воронеж, это Воронежская, Саратовская - Саратовская ,а не Саратов. И так далее, не коверкай названия населенных пунктов, пиши именно так, как тебе написали! Пиши буква в букву весь адрес как написал абонент. "
        "Сообщение: "
    )

    # Извлекаем адрес с помощью API Mistral
    extracted_address = mistral_large(message, address_extraction_prompt)
